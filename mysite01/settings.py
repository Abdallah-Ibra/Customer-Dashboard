...
SECRET_KEY = 'django-insecure-iw8j2x4nv33anci=!+ok2tf&r6gfm_+5rn+j*wa6e9ei-5e0%2'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'bookstore/static/imgs')
...
# Configure SMTP Details for Rest Customer Password
